...
class hrl1TableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $records = [
          ...
          ['name' => 'P1602', 'create_by' => 'SYSTEM', 'hrl1FirstName' => 'Methi', 'hrl1Lastname' => 'Assavinvipart', 'hrl1Supervisor' => 'P1601', 'hrl1DateStart' => \Carbon\Carbon::createFromDate(2016,1,1)->toDateTimeString(), 'hrl1Role1' => 'Senior engineer', 'hrl1Discipline' => 'Structural engineering', 'hrl1Category' => 'Professional', 'hrl1Grade' => 8, 'hrl1Position' => 'Senior engineer'],
          ['name' => 'P1603', 'create_by' => 'SYSTEM', 'hrl1FirstName' => 'Panupong', 'hrl1Lastname' => 'Srivarangkul', 'hrl1Supervisor' => 'P1601', 'hrl1DateStart' => \Carbon\Carbon::createFromDate(2016,1,1)->toDateTimeString(), 'hrl1DateEnd' => \Carbon\Carbon::createFromDate(2017,5,20)->toDateTimeString(), 'hrl1Role1' => 'Discipline engineer', 'hrl1Role2' => 'IT Manager', 'hrl1Discipline' => 'Pipeline engineering', 'hrl1Category' => 'Professional', 'hrl1Grade' => 7, 'hrl1Position' => 'Discipline engineer'],
